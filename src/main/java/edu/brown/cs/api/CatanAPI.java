...
public class CatanAPI {
	 ...
	 *            A JSON String representing the player's attributes. Should
	 *            contain a "name" and "color" field.
	 ...
	 *         poorly formed request. For example, if the JSON is missing a
	 *         given attribute for an action -1 will be returned and it will map
	 *         to a more specific message as to why the Action failed.
	 */
